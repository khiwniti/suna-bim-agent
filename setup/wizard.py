...
from setup.steps.carbon_bim import CarbonBIMStep
...
class SetupWizard:
    ...
    def _sync_step_completion(self) -> None:
        ...
        optional_steps = ["morph", "search_apis", "rapidapi", "carbon-bim", "webhook", "mcp"]
    ...
    def run(self) -> int:
        ...
        self.console.print(
            "This wizard will guide you through setting up Carbon BIM Suna, "
    ...
    def _show_final_instructions(self) -> None:
        ...
        self.console.print("\n✨ Carbon BIM Suna Setup Complete! ✨\n")

        self.console.info("Carbon BIM Suna is configured with your API keys and ready to use.")
        ...
        if self.config.setup_method == SetupMethod.DOCKER:
            self.console.info("Your Carbon BIM Suna instance is ready to use!")
            ...
            self.console.info("To start Carbon BIM Suna, run these commands in separate terminals:")
        ...
        self.console.print("\nOnce all services are running, access Carbon BIM Suna at: http://localhost:3000")
