...
class ConfigWriter:
    ...
    def write_backend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        env_vars = {
            ...
            # Carbon BIM
            "CARBON_BIM_ADMIN_API_KEY": config.carbon_bim.CARBON_BIM_ADMIN_API_KEY,
            # VAPI
        ...
        header = f"Generated by Carbon BIM Suna setup for '{setup_method}' setup"
    ...
    def write_frontend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        header = "Generated by Carbon BIM Suna setup"
        content = self._format_env_content(env_vars, header)
