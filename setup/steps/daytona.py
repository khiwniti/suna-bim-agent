...
class DaytonaStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info(
                "Carbon BIM Suna REQUIRES Daytona for sandboxing functionality. "
        ...
        self.warning(
            "IMPORTANT: You must create a Carbon BIM Suna snapshot in Daytona for it to work properly."
        )
        ...
        self.info("   - Name:          carbon-bim/suna:0.1.3.30")
        self.info("   - Snapshot name: carbon-bim/suna:0.1.3.30")
