...
class LLMProvidersStep(BaseStep):
    ...
    # Main LLM provider options for carbon-bim/basic and carbon-bim/power models
    ...
    def _configure_main_provider(self) -> None:
        """Configure the main LLM model (required for carbon-bim/basic)."""
        self.console.print("\n" + "=" * 60)
        self.console.print("[bold]Main LLM Model Selection[/bold]")
        self.console.print("=" * 60)
        self.info("Carbon BIM Suna requires a main LLM to power 'carbon-bim/basic' and 'carbon-bim/power'.")
        self.console.print("")
    ...
    def _collect_required_key(self, env_key: str, provider_name: str) -> None:
        ...
        while True:
            ...
            if api_key:
                ...
                self.error(f"{provider_name} API key is REQUIRED for Carbon BIM to function.")
