...
class StartupStep(BaseStep):
    """Start Carbon BIM Suna services."""

    name = "startup"
    display_name = "Starting Carbon BIM Suna"
    order = 16
    required = True
    ...
    def run(self) -> StepResult:
        ...
        self.info("\nHow would you like to start Carbon BIM Suna?")
    ...
    def _start_docker(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Carbon BIM Suna with Docker Compose...")
            ...
            try:
                ...
                if "backend" in result.stdout and "frontend" in result.stdout:
                    self.success("Carbon BIM Suna services are starting up!")
                else:
                    self.warning(
    ...
    def _start_manual(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Carbon BIM Suna automatically (manual mode)...")
            ...
            try:
                ...
                self.success("Carbon BIM Suna services started!")
