...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out Carbon BIM AI Workers',
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Carbon BIM Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Carbon BIM Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Carbon BIM Workers with custom Knowledge, Tools & Integrations',
