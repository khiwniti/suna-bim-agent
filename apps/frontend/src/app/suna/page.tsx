...
export const metadata: Metadata = {
  title: 'Suna is now Carbon BIM | Carbon BIM Suna - Open Source AI Worker',
  description: 'Suna has rebranded to Carbon BIM. Carbon BIM (formerly Suna) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Suna',
    'Carbon BIM Suna',
    'Suna AI',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Carbon BIM (formerly known as Suna) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-8 sm:pt-20 max-w-4xl mx-auto pb-10">
              {/* Carbon BIM Symbol with grain texture */}
              <div className="relative mb-8 sm:mb-12" style={{ width: '80px', height: '80px' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.6,
                    maskImage: 'url(/carbon-bim-symbol.svg)',
                    WebkitMaskImage: 'url(/carbon-bim-symbol.svg)',
                    maskSize: 'contain',
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Suna? You've found us. Carbon BIM is the evolution of Suna — the same open
              ...
              Suna", or "Carbon BIM Suna" — this is the official continuation of the Suna project under
              the Carbon BIM brand.
            </p>
          </div>
        </div>
      </main>
