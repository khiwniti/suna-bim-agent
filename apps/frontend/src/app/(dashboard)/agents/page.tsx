...
export default function AgentsPage() {
  ...
  const [marketplaceFilter, setMarketplaceFilter] = useState<'all' | 'carbon-bim' | 'community' | 'mine'>('all');
  ...
  const marketplaceQueryParams = useMemo(() => {
    ...
    if (marketplaceFilter === 'carbon-bim') {
      params.is_carbon_bim_team = true;
    } else if (marketplaceFilter === 'community') {
      params.is_carbon_bim_team = false;
