...
interface Slide {
  ...
  bulletPoints?: string[];
  accent?: string;
  diagram?: 'agent-loop' | 'carbon-bim-stack' | 'task-types' | 'token-flow' | 'messages-array' | 'sandbox-arch' | 'tools-overview';
...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at Carbon BIM',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see Carbon BIM in action',
  },
...
// Carbon BIM Stack Diagram
const CarbonBIMStackDiagram = () => {
  const layers = [
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'carbon-bim-stack' && <CarbonBIMStackDiagram />}
