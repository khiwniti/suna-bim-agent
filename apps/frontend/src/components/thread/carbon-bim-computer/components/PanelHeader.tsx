    ...
    return (
      <div className="h-12 flex-shrink-0 px-3 flex items-center justify-between border-b border-border bg-background/95 backdrop-blur-sm">
        ...
        <div className="flex items-center min-w-0">
          <Image
            src="/carbon-bim-computer-white.svg"
            alt="Carbon BIM Computer"
            width={120}
            height={14}
          ...
          />
          <Image
            src="/carbon-bim-computer-black.svg"
            alt="Carbon BIM Computer"
            width={120}
            height={14}
            ...
            priority
          />
          <DrawerTitle className="sr-only">Carbon BIM Computer</DrawerTitle>
        </div>
