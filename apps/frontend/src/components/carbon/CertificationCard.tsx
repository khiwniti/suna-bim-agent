...
const CERTIFICATION_COLORS = {
  edge: 'from-[var(--carbon-primary)]/20 to-[var(--carbon-accent)]/20',
  trees: 'from-lime-500/20 to-[var(--carbon-primary)]/20',
...
export function CertificationCard({
  ...
  return (
    <div
      className={cn(
        'carbon-glass-card group relative rounded-xl border transition-all duration-300',
        'hover:border-[var(--carbon-primary)]/50 cursor-pointer',
        onClick && 'carbon-shadow-glow',
        className
      )}
      onClick={onClick}
    >
