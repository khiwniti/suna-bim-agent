...
export function DashboardPromoBanner() {
  ...
  // Show Welcome Bonus promo or CARBONBIM26 for free tier users
  const shouldShowPromo = promo?.isActive && (promo.promoId === 'welcome-bonus' || promo.promoCode === 'CARBONBIM26');
