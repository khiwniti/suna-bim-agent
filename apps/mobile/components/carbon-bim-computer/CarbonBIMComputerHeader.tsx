...
interface CarbonBIMComputerHeaderProps {
...
/**
 * Shared header component for all Carbon BIM Computer views (Files, File Viewer, Browser).
 ...
 */
export function CarbonBIMComputerHeader({
  icon: IconComponent,
  onIconClick,
  iconTitle,
  title,
