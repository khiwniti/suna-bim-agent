...
import { CarbonBIMLoader } from '@/components/ui';
...
import CarbonBIMSymbolBlack from '@/assets/brand/carbon-bim-symbol-scale-effect-black.svg';
import CarbonBIMSymbolWhite from '@/assets/brand/carbon-bim-symbol-scale-effect-white.svg';
...
function AuthBackgroundLogo() {
  ...
  const SymbolComponent = colorScheme === 'dark' ? CarbonBIMSymbolWhite : CarbonBIMSymbolBlack;
  ...
  return (
    ...
    >
        ...
        <View style={{ marginBottom: SPACING.logoToTitle }}>
          <CarbonBIMLogo variant="logomark" size={24} color={isDark ? 'dark' : 'light'} />
        </View>
