...
export default function ShareThreadPage() {
  ...
  // Carbon BIM Computer for viewing tool calls
  const { isOpen: isCarbonBIMComputerOpen, openPanel } = useCarbonBIMComputerStore();
  const [selectedToolData, setSelectedToolData] = React.useState<{
    toolMessages: ToolMessagePair[];
    initialIndex: number;
  } | null>(null);

  // Handle tool press - open Carbon BIM Computer
