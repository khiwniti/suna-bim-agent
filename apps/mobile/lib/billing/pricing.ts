...
export interface PricingTier {
  ...
  revenueCatId?: string; // RevenueCat product identifier (e.g., 'carbon_bim_plus_monthly')
}
...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    features: [
      ...
      '2 concurrent runs',
      '10 Chats',
      'Basic Mode - Core Carbon BIM experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      // '5 custom AI Workers - Create Carbon BIM Agents with custom Knowledge, Tools & Integrations',
      ...
      'Carbon BIM Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
    isPopular: true,
    buttonText: 'Get started',
    hidden: false,
    icon: Zap,
    revenueCatId: 'carbon_bim_plus',
  },
  {
    id: 'tier_6_50',
    name: 'Pro',
    ...
    features: [
      ...
      // '20 custom AI Workers - Create Carbon BIM Agents with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      // '100 custom AI Workers - Create Carbon BIM Agents with custom Knowledge, Tools & Integrations',
