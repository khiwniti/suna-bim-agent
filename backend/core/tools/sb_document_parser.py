...
class SandboxDocumentParserTool(SandboxToolsBase):
    ...
    async def parse_document(
        ...
        try:
            ...
            parsed_content = self._extract_meaningful_content(
                task, extract_tables, extract_structured_data
            )
    ...
    def _extract_meaningful_content(
        self, task, extract_tables: bool, extract_structured_data: bool
    ) -> Dict[str, Any]:
                ...
                for chunk in output.chunks:
                    if hasattr(chunk, "segments"):
                        for segment in chunk.segments:
                            ...
                            if (
                                clean_content and len(clean_content.strip()) > 3
                                ...
                                if "title" in seg_type:
                                    ...
                                    content["text_content"].append(
                                        {"text": clean_content, "page": segment_info["page"]}
                                    )
    ...
    def _create_content_summary(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "main_headings": [
                item["content"] for item in content["structure"][:5]
            ],  # First 5 headings
        }
