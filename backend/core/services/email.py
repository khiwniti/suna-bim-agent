...
<head>
  ...
  <title>Welcome to Carbon BIM</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="Carbon BIM Logo" class="logo">
    </div>
    ...
    <p>Thanks again, and welcome to the Carbon BIM community!</p>
  </div>
</body>
</html>"""
...
Thanks again, and welcome to the Carbon BIM community!
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join Carbon BIM using a personal referral code.
      ...
      <td>
        ...
        <div style="text-align: center; margin-top: 32px;">
          <p style="font-size: 12px; color: #999; margin: 0;">
            &copy; Carbon BIM AI Corp. All rights reserved.
          </p>
        </div>
      </td>
    </tr>
...
© Carbon BIM AI Corp. All rights reserved."""
    ...
    def send_otp_email(self, user_email: str, otp_code: str) -> bool:
        ...
        subject = "Your Carbon BIM verification code"
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #fafafa; color: #1a1a1a;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px; margin: 0 auto; padding: 40px 20px;">
    ...
    def _get_otp_email_text(self, otp_code: str) -> str:
        return f"""Your Carbon BIM verification code
