...
class Configuration:
    ...
    MEMORY_EXTRACTION_MODEL: Optional[str] = "carbon-bim/basic"
    ...
    OR_SITE_URL: Optional[str] = "http://20.55.21.69:30"
    OR_APP_NAME: Optional[str] = "Carbon BIM"
    ...
    CARBON_BIM_ADMIN_API_KEY: Optional[str] = None
    ...
    def FRONTEND_URL(self) -> str:
        ...
        Returns:
        - Production: 'http://20.55.21.69:30' (or FRONTEND_URL_ENV if set)
        - Staging: 'http://20.55.21.69:30' (or FRONTEND_URL_ENV if set)
    ...
    def _generate_admin_api_key(self) -> str:
        """Generate a secure admin API key for Carbon BIM administrative functions."""
    ...
    def _validate(self):
        ...
        for field, field_type in type_hints.items():
            ...
            if self.ENV_MODE == EnvMode.LOCAL and field == "SUPABASE_JWT_SECRET":
                continue
