...
async def insert_admin_audit_log(
    admin_account_id: str, action: str, target_account_id: str, details: dict[str, Any]
) -> dict[str, Any]:
...
async def get_user_transactions_paginated(
    account_id: str, page: int = 1, page_size: int = 20, type_filter: Optional[str] = None
    ...
    params: dict[str, Any] = {"account_id": account_id, "limit": page_size, "offset": offset}
...
async def get_recent_transactions(account_id: str, limit: int = 20) -> list[dict[str, Any]]:
