...
class ErrorMapper:
    MAPPINGS = {
        "RATE_LIMIT": UserFriendlyError(
            ...
            recoverable=True,
            actions=[{"type": "retry", "label": "Try again", "delay_seconds": 5}],
        ),
        ...
        "CONCURRENT_LIMIT": UserFriendlyError(
            ...
            recoverable=True,
            actions=[{"type": "retry", "label": "Try again", "delay_seconds": 10}],
        ),
        ...
        "SANDBOX_UNAVAILABLE": UserFriendlyError(
            ...
            recoverable=True,
            actions=[{"type": "retry", "label": "Try again", "delay_seconds": 30}],
        ),
        ...
        "AUTHENTICATION_EXPIRED": UserFriendlyError(
            ...
            recoverable=False,
            actions=[{"type": "link", "label": "Sign in", "url": "/login"}],
        ),
    ...
    @classmethod
    def map_error(cls, error: Exception, error_code: Optional[str] = None) -> UserFriendlyError:
    ...
    @classmethod
    def to_stream_event(cls, error: Exception, error_code: Optional[str] = None) -> Dict[str, Any]:
