...
async def get_all_tools(user_id: str = Depends(verify_and_get_user_id_from_jwt)) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "tools": tools_metadata}
...
async def get_tool_details(
    tool_name: str, user_id: str = Depends(verify_and_get_user_id_from_jwt)
) -> Dict[str, Any]:
