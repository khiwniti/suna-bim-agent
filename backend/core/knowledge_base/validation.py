...
class FileNameValidator:
    ...
    def generate_unique_name(
        cls, base_name: str, existing_names: list, item_type: str = "file"
    ) -> str:
        """
...
async def validate_folder_name_unique(
    name: str, account_id: str, exclude_folder_id: str = None
) -> None:
    ...
    query = (
        client.table("knowledge_base_folders")
        .select("folder_id")
...
async def validate_file_name_unique_in_folder(
    filename: str, folder_id: str, exclude_entry_id: str = None
) -> str:
    """
