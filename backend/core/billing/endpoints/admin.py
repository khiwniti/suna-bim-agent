...
async def trigger_reconciliation(
    ...
    try:
        logger.info(
            f"[RECONCILIATION] Manual reconciliation triggered by admin for account {account_id}"
        )
...
async def get_circuit_breaker_status(
    ...
    try:
        ...
        return {"circuit_breaker": status, "message": "Circuit breaker status retrieved"}
    except Exception as e:
