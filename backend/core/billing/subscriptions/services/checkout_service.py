...
from core.billing.shared.config import get_tier_by_price_id, get_price_type, get_plan_type
...
class CheckoutService:
    ...
    def generate_idempotency_key(
        self, account_id: str, price_id: str, commitment_type: Optional[str]
    ) -> str:
    ...
    async def get_current_subscription_status(self, account_id: str) -> Dict:
        credit_account = await self.credit_account_repo.get_credit_account_with_subscription(
            account_id
        )
