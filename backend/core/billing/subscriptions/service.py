...
class SubscriptionService:
    ...
    async def handle_subscription_change(
        ...
        return await SubscriptionLifecycleHandler.handle_subscription_change(
    ...
    async def schedule_tier_downgrade(
        self, account_id: str, target_tier_key: str, commitment_type: Optional[str] = None
    ) -> Dict:
        return await SchedulingHandler.schedule_tier_downgrade(
            account_id, target_tier_key, commitment_type
        )
    ...
    async def get_scheduled_changes(
        self, account_id: str, subscription_data: Optional[Dict] = None
    ) -> Dict:
