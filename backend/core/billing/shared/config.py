...
TIERS: Dict[str, Tier] = {
    "none": Tier(
        ...
        memory_config={"enabled": False, "max_memories": 0, "retrieval_limit": 0},
    ),
    "free": Tier(
        name="free",
        ...
        scheduled_triggers_limit=0,
        app_triggers_limit=0,
        memory_config={"enabled": True, "max_memories": 10, "retrieval_limit": 2},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("3.00"),
    ...
    "tier_2_20": Tier(
        ...
        memory_config={"enabled": True, "max_memories": 100, "retrieval_limit": 15},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
    ...
    "tier_6_50": Tier(
        ...
        memory_config={"enabled": True, "max_memories": 500, "retrieval_limit": 25},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_25_200": Tier(
        ...
        memory_config={"enabled": True, "max_memories": 2000, "retrieval_limit": 40},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_12_100": Tier(
        ...
        app_triggers_limit=50,
        memory_config={"enabled": True, "max_memories": 1000, "retrieval_limit": 30},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_50_400": Tier(
        ...
        app_triggers_limit=200,
        memory_config={"enabled": True, "max_memories": 5000, "retrieval_limit": 50},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_125_800": Tier(
        ...
        memory_config={"enabled": True, "max_memories": 10000, "retrieval_limit": 60},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_200_1000": Tier(
        ...
        memory_config={"enabled": True, "max_memories": 25000, "retrieval_limit": 80},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
    ...
    "tier_150_1200": Tier(
        ...
        scheduled_triggers_limit=500,
        app_triggers_limit=1000,
        memory_config={"enabled": True, "max_memories": 30000, "retrieval_limit": 100},
        daily_credit_config={
            "enabled": True,
            "amount": Decimal("2.00"),
            "refresh_interval_hours": 24,
...
def get_tier_limits(tier_name: str) -> Dict:
    ...
    return {
        ...
        or {"enabled": False, "max_memories": 0, "retrieval_limit": 0},
    }
