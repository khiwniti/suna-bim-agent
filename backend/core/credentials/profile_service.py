...
class ProfileService:
    ...
    async def store_profile(
        ...
        success = await credentials_repo.create_credential_profile(
            profile_id, account_id, mcp_qualified_name, profile_name, display_name, encoded_config
        )
    ...
    async def set_default_profile(self, account_id: str, profile_id: str) -> bool:
        ...
        success = await credentials_repo.set_default_profile(
            account_id, profile_id, profile.mcp_qualified_name
        )
