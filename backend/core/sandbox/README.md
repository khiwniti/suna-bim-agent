...
2. Build a custom image:
   ...
   docker push carbon-bim/carbon-bim:0.1.3.30
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `carbon-bim/carbon-bim:___`)
...
3. Push the new version: `docker push carbon-bim/carbon-bim:0.1.3`
