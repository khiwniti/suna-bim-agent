# Carbon BIM Agent Evaluations

Evaluate Carbon BIM agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/Carbon BIM/p/Carbon BIM%20Agent/experiments/
...
| `EVAL_MODEL` | Override model for evals (default: `carbon-bim/basic`) |
