"""
Carbon BIM Agent Evaluation Script.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run Carbon BIM Agent evaluations",
...
Examples:
    ...
    parser.add_argument(
        "positional_dataset", nargs="?", default=None, help="Dataset name (positional)"
    )

    parser.add_argument(
        "positional_count", nargs="?", type=int, default=None, help="Number of tests (positional)"
    )
    ...
    parser.add_argument(
        ...
        "--model",
        type=str,
        default=os.getenv("EVAL_MODEL", "carbon-bim/basic"),
        help="Model to use (default: carbon-bim/basic)",
    )
    ...
    parser.add_argument(
        "-l", "--list", action="store_true", help="List available datasets and exit"
    )
...
""")
    ...
    # Run evaluation
    Eval(
        "Carbon BIM Agent",  # Project name in Braintrust
        data=get_eval_data,
